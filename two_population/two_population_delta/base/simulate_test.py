...
number_example=5000*0.2
noise_factor=1
death_rate_1=float(sys.argv[1])
...
np.savetxt('test_death_status.txt',np.asarray(death_status))
np.savetxt('test_observation_date.txt',np.asarray(observation_date))
...
try:
    feature_vector_all=np.asarray(feature_vector_all)[:,:,0].T
    np.savetxt('test_feature.txt',feature_vector_all)
except:
    feature_vector_all=np.asarray(feature_vector_all).T
    np.savetxt('test_feature.txt',feature_vector_all)
